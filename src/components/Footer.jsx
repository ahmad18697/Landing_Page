      ...
      <div className="section-container">
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="w-4 h-4 bg-teal-500 rounded-full -ml-2"></div>
              <span className="text-xl font-medium ml-1">Ahmad Raza</span>
            </motion.div>
            <motion.p 
              variants={fadeIn('up', 0.6)}
              className="text-gray-600 mb-6"
            >
              Crafting seamless digital experiences with a focus on performance and design. Let’s build something amazing together!
            </motion.p>
            <motion.div 
            ...
            >
              ...
              <motion.a 
                ...
                target="_blank" 
                className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 hover:bg-gray-800 hover:text-white transition-colors"
              >
        ...
        >
          ...
          >
            ...
            >
              Copyright © {new Date().getFullYear()} Ahmad Raza
            </motion.p>
            <motion.p 
